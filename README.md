...
2) The app will not refresh the counts of classes that were registered for or saved in a shopping cart immediately. For now, you can click the menus and the count will be refreshed. The 'trigger()' property of jQuery was tried to refresh the count but at this time it was not successful. I will continue exploring other techniques that will refresh each time the register, drop, or delete buttons are clicked. (https://github.com/tsehayegh/university-mall/issues/9)
...
(https://github.com/tsehayegh/university-mall/issues/8)